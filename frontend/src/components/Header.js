...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* Recuerda actualizar la lógica dentro de CartDrawer si usaba onNavigate */}
      <CartDrawer open={drawerOpen} onClose={() => setDrawerOpen(false)} onNavigate={(target) => navigate(`/${target}`)} />
    </>
  );
};
